    ...
    <center> 
        <br>
        <h1>JURUSAN</h1>
        <p>SMK (Sekolah Menengah Kejuruan) adalah pendidikan menengah yang menyiapkan pelajar untuk langsung bekerja setelah lulus. 
            <br>Jadi selain belajar teori, praktek juga sangat banyak. Jadi tentukan pilihan jurusan kamu sekarang </p>
    </center>
   <div div class="d-flex justify-content-center">
         <div class="parent">
            <div class="card">
                ...
                <div class="glass"></div>
                <div class="content">
                    <span class="title">TKRO</span>
                    <span class="text">Jurusan yang paling diminati oleh para anak zaman now</span>
                </div>
                <div class="bottom">
         ...
         <div class="parent">
            <div class="card">
                ...
                <div class="glass"></div>
                <div class="content">
                    <span class="title">TKJ</span>
                    <span class="text">Jurusan Teknik Komputer dan Jaringan adalah salah satu jurusan yang paing populer</span>
                </div>
                <div class="bottom">
        ...
        <div class="parent">
            <div class="card">
                ...
                <div class="glass"></div>
                <div class="content">
                    <span class="title">RPL</span>
                    <span class="text">Jurusan Rekayasa Perangkat Lunak adalah salah satu jurusan...</span>
                </div>
                <div class="bottom">
        ...
        <div class="parent">
            <div class="card">
                ...
                <div class="content">
                    ...
                    <span class="text">Jurusan Multimedia tidak kalah menarik loh...</span>
                </div>
                <div class="bottom">
